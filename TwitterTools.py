...
def actBack():
    print("You are Return To The Main Menu:)")
    UserInput = input("What Can I Do For You?:)")


os.system("title Twitter Tools v1.0.1")
os.system('cls' if os.name == 'nt' else 'clear')
print ("[-] Twitter Tools v1.0.1")
